                                  ...
                                  const unsigned char *key, size_t key_size)
{
    ...
    type = (mbedtls_lms_algorithm_type_t)mbedtls_lms_network_bytes_to_unsigned_int(MBEDTLS_LMS_TYPE_LEN,
    ...
    otstype = (mbedtls_lmots_algorithm_type_t)mbedtls_lms_network_bytes_to_unsigned_int(MBEDTLS_LMOTS_TYPE_LEN,
