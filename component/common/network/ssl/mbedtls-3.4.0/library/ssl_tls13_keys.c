...
int mbedtls_ssl_tls13_key_schedule_stage_early(mbedtls_ssl_context *ssl)
{
    ...
    hash_alg = mbedtls_hash_info_psa_from_md((mbedtls_md_type_t)handshake->ciphersuite_info->mac);
                                             ...
                                             mbedtls_ssl_key_set *traffic_keys)
{
    ...
    hash_alg = mbedtls_hash_info_psa_from_md((mbedtls_md_type_t)ciphersuite_info->mac);
    hash_len = PSA_HASH_LENGTH(hash_alg);
